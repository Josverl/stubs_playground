...
|---|---|
| `@mp-codemirror/lsp-client` | Stable CodeMirror integration and worker control-plane client. Independently versioned on npm. |
...
Existing `@mp-codemirror/pyright-worker` consumers remain supported throughout
