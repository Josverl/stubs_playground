...
1. `packages/pyright-worker/scripts/pack-typeshed.py` — packs Pyright's typeshed-fallback into a deflated zip (~0.6 MB)
2. `packages/pyright-worker/scripts/pack-stubs.py` — packs MicroPython board stubs into per-board zips
