/**
 * Share core utilities (no app-specific DOM wiring)
 *
 * Includes URL encoding/decoding, project payload compression, issue URL
 * building, and scope resolution helpers.
 */
 ...
 */
export async function resolveFilesForScope(scope, getCode, getActiveFileName, getFiles) {
