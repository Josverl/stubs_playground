...
export type WorkerMessage = MsgServerLoaded | MsgInitServer | MsgServerInitialized | MsgServerError | MsgSyncFile | MsgDeleteFile | MsgDebugListFs | MsgDebugListFsResult | MsgReadGeneratedConfig | MsgReadGeneratedConfigResult;
